...
export const HeroSection = () => (
  <section className="relative min-h-[60vh] overflow-hidden min-w-screen">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20">
      <div className="text-center">
        ...
        <Paragraph className="text-xl md:text-2xl text-slate-300 max-w-3xl mx-auto">
          We are on a mission to make astronomy accessible, interactive, and
          inspiring for everyone. Join thousands of space enthusiasts exploring
          the cosmos together.
        </Paragraph>
      </div>
    </div>
